...
describe('ZennArticleList', () => {
  ...
  test('初期表示', async () => {
    ...
    await TestingLibrary.waitFor(() =>
      TestingLibrary.screen.getByText(zennArticleList[0].name),
    );

    expect(TestingLibrary.screen.getByText(zennArticleList[0].name)).toBeInTheDocument();
    expect(TestingLibrary.screen.getByText(zennArticleList[1].name)).toBeInTheDocument();
    expect(TestingLibrary.screen.getByText(zennArticleList[2].name)).toBeInTheDocument();
    expect(TestingLibrary.screen.getByText(zennArticleList[3].name)).toBeInTheDocument();
    expect(TestingLibrary.screen.getByText(zennArticleList[4].name)).toBeInTheDocument();
    expect(TestingLibrary.screen.getByText(zennArticleList[5].name)).toBeInTheDocument();
  });
});
