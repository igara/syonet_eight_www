...
describe('BlogsZennArticleNamePage', () => {
  beforeEach(() => {
    jest.resetModules();
  });

  test('初期表示', () => {
    const zennDetail = 'hoge';
