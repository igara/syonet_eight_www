...
describe('HatenaList', () => {
  ...
  test('初期表示', async () => {
    ...
    expect(TestingLibrary.screen.getByText(hatenaList[1].name)).toBeInTheDocument();
    expect(TestingLibrary.screen.getByText(hatenaList[2].name)).toBeInTheDocument();
    expect(TestingLibrary.screen.getByText(hatenaList[3].name)).toBeInTheDocument();
    expect(TestingLibrary.screen.getByText(hatenaList[4].name)).toBeInTheDocument();
    expect(TestingLibrary.screen.getByText(hatenaList[5].name)).toBeInTheDocument();
  });
});
